...
var texture = "Texture: 1"; //prendo il primo elemento per la navicella scelta
...
var invaderDx = -5
var invaders = [];
var cannon = new GameObject(300, 440, setCannone())
var invaderShot, cannonShot

function setCannone(){
    var cannone = document.getElementById("cannon");
    cannone.src = "IMMAGINI/GAME/" + texture + ".png";
    return cannone;
}
...
function restartGame() {
    ...
    restart.innerHTML = "<button> RIGIOCARE </button>";
